package net.esoteric_slime.template_paper_plugin.http_server;

import com.sun.net.httpserver.HttpServer;

import net.esoteric_slime.template_paper_plugin.TemplatePaperPlugin;
import net.esoteric_slime.template_paper_plugin.file.FileUtil;
import net.esoteric_slime.template_paper_plugin.http_server.event.listeners.PlayerJoinListener;
